...
namespace DeformEditor
{
	public static class MenuItemActions
	{
		...
		{
			var deformables = GameObject.FindObjectsByType<Deformable> (FindObjectsSortMode.None);
			...
			var groupDeformers = GameObject.FindObjectsByType<GroupDeformer> (FindObjectsSortMode.None);
