...
// Additional modifications by Sid Greenwood for broad project useage at Michigan State University
...
namespace XnTools {
	...
	public class XnReadMeEditor : Editor {
		...
		public override void OnInspectorGUI() {
			var pInfo = (XnReadMe_SO) target;
			Init();
			// Initialize a code block to check for GUI changes
			...
			if ( pInfo.showReadMeEditor ) {
				...
				GUILayout.Label( "<b>ReadMe Actions</b>", HeadingStyle );
				...
				if ( GUILayout.Button( "Reset ReadMe to Defaults" ) ) {
					if ( EditorUtility.DisplayDialog( "Reset ReadMe to Defaults?",
						    "Are you sure you want to reset this ReadMe file to the default values?" +
